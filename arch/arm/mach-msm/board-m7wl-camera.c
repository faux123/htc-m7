...
static void m7wl_cam_on_check_vcm(void);
#endif
...
#if defined(CONFIG_IMX135) || defined(CONFIG_VD6869) || defined(CONFIG_AR0260) || defined(CONFIG_OV2722)
	.camera_on_check_vcm = m7wl_cam_on_check_vcm, 
#endif
	.pdata	= &m7wl_msm_camera_csi_device_data[0],
...
static void do_cam_vcm_off_work(struct work_struct *work)
{
	...
	mdelay(10);
	rumbas_move_lens_position_by_stroke(0);
	mdelay(20);
#endif
	rumbas_poweroff_af();
